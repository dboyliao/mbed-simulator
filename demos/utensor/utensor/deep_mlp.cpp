...
}
{
    ...
    ctx.add(t_import.int_import("/fs/idx_data/Layer1_MatMul_eightbit_reshape_dims_0.idx"),
...
{
    TensorIdxImporter t_import;
    ctx.add(t_import.int_import("/fs/idx_data/Layer1_MatMul_eightbit_reduction_dims_0.idx"),
...
{
    TensorIdxImporter t_import;
    ctx.add(t_import.ubyte_import("/fs/idx_data/Layer1_Variable_quint8_const_0.idx"),
            "Layer1/Variable_quint8_const:0",
            1);
}
{
    TensorIdxImporter t_import;
    ctx.add(t_import.float_import("/fs/idx_data/Layer1_Variable_min_0.idx"),
            "Layer1/Variable_min:0",
            1);
}
{
    TensorIdxImporter t_import;
    ctx.add(t_import.float_import("/fs/idx_data/Layer1_Variable_max_0.idx"),
...
{
    TensorIdxImporter t_import;
    ctx.add(t_import.float_import("/fs/idx_data/Layer1_Variable_1_0.idx"),
            "Layer1/Variable_1:0",
            1);
}
{
...
{
    TensorIdxImporter t_import;
    ctx.add(t_import.int_import("/fs/idx_data/Layer1_Relu_eightbit_reshape_dims_0.idx"),
...
{
    TensorIdxImporter t_import;
    ctx.add(t_import.int_import("/fs/idx_data/Layer1_Relu_eightbit_reduction_dims_0.idx"),
...
{
    TensorIdxImporter t_import;
    ctx.add(t_import.ubyte_import("/fs/idx_data/Layer2_Variable_quint8_const_0.idx"),
            "Layer2/Variable_quint8_const:0",
            1);
}
{
    TensorIdxImporter t_import;
    ctx.add(t_import.float_import("/fs/idx_data/Layer2_Variable_min_0.idx"),
            "Layer2/Variable_min:0",
            1);
}
{
    TensorIdxImporter t_import;
    ctx.add(t_import.float_import("/fs/idx_data/Layer2_Variable_max_0.idx"),
...
{
    TensorIdxImporter t_import;
    ctx.add(t_import.float_import("/fs/idx_data/Layer2_Variable_1_0.idx"),
            "Layer2/Variable_1:0",
            1);
}
{
...
{
    TensorIdxImporter t_import;
    ctx.add(t_import.int_import("/fs/idx_data/Layer2_Relu_eightbit_reshape_dims_0.idx"),
...
{
    TensorIdxImporter t_import;
    ctx.add(t_import.int_import("/fs/idx_data/Layer2_Relu_eightbit_reduction_dims_0.idx"),
...
{
    TensorIdxImporter t_import;
    ctx.add(t_import.ubyte_import("/fs/idx_data/OuputLayer_Variable_quint8_const_0.idx"),
            "OuputLayer/Variable_quint8_const:0",
            1);
}
{
    TensorIdxImporter t_import;
    ctx.add(t_import.float_import("/fs/idx_data/OuputLayer_Variable_min_0.idx"),
            "OuputLayer/Variable_min:0",
            1);
}
{
    TensorIdxImporter t_import;
    ctx.add(t_import.float_import("/fs/idx_data/OuputLayer_Variable_max_0.idx"),
...
{
    TensorIdxImporter t_import;
    ctx.add(t_import.float_import("/fs/idx_data/OuputLayer_Variable_1_0.idx"),
...
{
    TensorIdxImporter t_import;
    ctx.add(t_import.int_import("/fs/idx_data/y_pred_dimension_0.idx"),
            "y_pred/dimension:0",
            1);
}
{
